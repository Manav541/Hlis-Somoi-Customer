export const images = {
  ...
  orderPlacedUn: require("../assets/images/orderPlacedUn.png"),
  orderConfirmed: require("../assets/images/orderConfirmed.png"),
  orderConfirmedUn: require("../assets/images/orderConfirmedUn.png"),
  preparing: require("../assets/images/preparing.png"),
  preparingUn: require("../assets/images/preparingUn.png"),
  onTheWay: require("../assets/images/onTheWay.png"),
  onTheWayUn: require("../assets/images/onTheWayUn.png"),
  orderDelivered: require("../assets/images/orderDelivered.png"),
  orderDeliveredUn: require("../assets/images/orderDeliveredUn.png"),
  orderReturned: require("../assets/images/orderReturned.png"),
  orderReturnedUn: require("../assets/images/orderReturnedUn.png"),
  orderCancelled: require("../assets/images/orderCancelled.png"),
