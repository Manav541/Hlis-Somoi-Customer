...
import ViewAllSubCategoriesComponenet from '../../components/viewAllSubCategories';
...
const ViewAllSubCategoriesContainer = ({navigation, route} : any) => {
  ...
  return (
    <ViewAllSubCategoriesComponenet arrAllCategories={arrAllCategories} onPressCategory={onPressCategory} />
  )
}
